...
public class ProudsoulShapelessRecipe extends ShapelessRecipe {
	...
	public static class Serializer implements RecipeSerializer<ProudsoulShapelessRecipe> {
		public ProudsoulShapelessRecipe fromJson(ResourceLocation p_44290_, JsonObject p_44291_) {
		...
		public ProudsoulShapelessRecipe fromNetwork(ResourceLocation p_44293_, FriendlyByteBuf p_44294_) {
