...
public class EntityDropEntry {
    public static final Codec<EntityDropEntry> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ResourceLocation.CODEC.fieldOf("entity_type").forGetter(EntityDropEntry::getEntityType),
            ...
            Codec.BOOL.optionalFieldOf("request_slashblade", false).forGetter(EntityDropEntry::isRequestSlashBladeKill),
